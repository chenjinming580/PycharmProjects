# author:JinMing time:2020-04-11
#导包
...
#找到元素60
ibox=driver.find_element_by_id('com.ibox.calculators:id/cv')
text=ibox.find_elements_by_class_name('android.widget.TextView')[1].text
