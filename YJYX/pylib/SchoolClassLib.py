...
class SchoolClassLib:
    ...
    def modify_school_class(self, classid, newname, newstudentlimit):
        ...
        url = '{}/{}'.format(SchoolClassUrl, classid)
    ...
    def list_school_class(self, gradeid=None):
        ...
        response = requests.get(SchoolClassUrl, params=params)
    ...
    def add_school_class(self, gradeid, name,
        ...
        response = requests.post(SchoolClassUrl, data=payload)
        ...
        if idSavedName:
            print('before')
            BuiltIn().set_global_variable(f'${idSavedName}', bodyDict['id'])
